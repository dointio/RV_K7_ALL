...
int main(int argc, char *argv[], char *envp[]) {
  ...
  while (1) {
    ...
    switch (e.key.keysym.sym) {
      case SDLK_0: i = 0; printf("Press %d\n", i); break;
      case SDLK_1: i = 1; printf("Press %d\n", i); break;
      case SDLK_2: i = 2; printf("Press %d\n", i); break;
      case SDLK_3: i = 3; printf("Press %d\n", i); break;
      case SDLK_4: i = 4; printf("Press %d\n", i); break;
      case SDLK_5: i = 5; printf("Press %d\n", i); break;
      case SDLK_6: i = 6; printf("Press %d\n", i); break;
      case SDLK_7: i = 7; printf("Press %d\n", i); break;
      case SDLK_8: i = 8; printf("Press %d\n", i); break;
      case SDLK_9: i = 9; printf("Press %d\n", i); break;
